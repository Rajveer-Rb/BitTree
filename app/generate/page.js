...
//                 <div style={{ backgroundImage: "url('/banner.png')" }} className="col2 flex flex-col md:justify-center items-center w-full min-h-screen md:min-h-[110vh] bg-cover bg-center bg-no-repeat">

//                     <Link href="/"><img className='h-6 absolute top-8 left-8 md:hidden' src="/logo2.svg" alt="" />
//                     </Link>

//                     <h1 className='text-5xl font-bold md:hidden mt-40'>Create your Bitree</h1>

//                     <div className='flex flex-col justify-center gap-5 my-12 bg-yellow-50 md:hidden'>

//                         <div className='item'>
//                             <h3 className='text-xl'>Step 1: Claim your Handle</h3>
//                             <div className='flex gap-2 mx-4'>
//                                 <input value={handle || ""} onChange={e => { setHandle(e.target.value) }} className='rounded-md md:px-4 py-3 bg-gray-200' type="text" placeholder='Chose a Handle' />
//                                 <input value={session.user.email || ""} onChange={e => { setEmail(e.target.value) }} className='rounded-md md:px-4 py-3 bg-gray-200' type="text" placeholder='Enter your email' />
//                             </div>
//                         </div>

//                         <div className='item'>
//                             <h3 className='text-xl'>Step 2: Add your Links</h3>
...
//                         <div className='item'>
//                             <h3 className='text-xl'>Step 3: Finish up by adding Profile & Description</h3>
//                             <div className="mx-4 flex gap-2">
//                                 <input onChange={e => { setPic(e.target.value) }} value={pic || ""} className='rounded-md px-4 py-3 bg-gray-200 my-2' type="text" placeholder='Enter profile link' />
//                                 <input onChange={e => { setDesc(e.target.value) }} value={desc || ""} className='rounded-md px-4 py-3 bg-gray-200 my-2' type="text" placeholder='Short description' />
//                             </div>
...
export default function Page({ searchParams }) {
  // Pass the handle from the query string to the Generate component
  return <Generate initialHandle={searchParams?.handle || ''} />;
}
